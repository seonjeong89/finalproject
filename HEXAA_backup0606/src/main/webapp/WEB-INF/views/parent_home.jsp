	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="card card-light card-outline">
					<div class="card-header">
						출결 상황및 프로필<select id="selectChild" name="child" class="form-control float-right" style="padding: 0; font-size: .8rem; line-height: 1; height: 19px; width:100px;">
											<option value="" selected>자녀 선택</option>
											<c:forEach items="${selectChildList}" var="selectChildList" varStatus="loop"> 
											<option value="${selectChildList.name}" data-id="${selectChildList.id}">${selectChildList.name}</option>
				      ...
				      <div class="col-sm-6" style="padding:5px; margin:0px; border: 1px solid white; border-radius:15px; height:280px;">
				      	<div class="row">
				      		<div class="col-sm-12" style="border: 1px solid white; height: 12vh;">		      		
						      	...
						      	<div class="col-sm-12">
						      		담임선생님: ${selectStudentGetMain.mngName}
						      		<span style="margin-left: 1vh;"></span>
						      	</div>
				      		</div>
			...
			<div class="col-sm-6" style="height: 380px">
				<div class="card card-light card-outline">
					<div class="card-header">
						나의 학교 성적<a href="/member/score/gradeCheck.do" style="float: right" ><i class="fas fa-solid fa-plus" style="margin-left: 10px;"></i></a><%-- <select class="form-control float-right"  id="selectExamMember" style="width:100px; padding: 0; font-size: .8rem; line-height: 1; height: 19px;">
 												<option>시험선택</option>
...
window.onload=function(){
	let id = '${selectStudentGetMain.id}';
...
//			timeRequestForm.submit();
	...
	$("#selectChild").on("change",function(){
		let studentId = $("#selectChild option:selected").attr("data-id");
		console.log(studentId)
		/* opener.locationreloadss(studentId) */
		location.href = "/parent/main.do?studentId="+studentId;
		
		
	});
	
	console.log($('#selectChild').val())
	console.log('${dataMap.id }')
	/* console.log($('#selectChild').attr()) */
